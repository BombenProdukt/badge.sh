<header class="text-center">
    <h1 class="text-4xl font-bold sm:text-5xl lg:text-6xl p-1">
        <span class="text-indigo-600">Sharp, Fast &amp; Hackable</span>
        <span class="block text-gray-900">badge generation service</span>
    </h1>

    <p class="max-w-2xl mt-5 mx-auto text-xl text-gray-500">
        A pixel-perfect, retina-ready solution that provides fast, consistent performance, hackable customization, and
        no tracking.
    </p>
</header>
