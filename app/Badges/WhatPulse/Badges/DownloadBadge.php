...
final class DownloadBadge implements Badge
{
    ...
    {
        return TextTemplate::make('download', Arr::get($this->client->get($userType, $id), $userType === 'team' ? 'Team.Download' : 'Download'), 'green.600');
    }
